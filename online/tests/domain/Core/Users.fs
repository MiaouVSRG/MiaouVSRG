...
module Users =
    ...
    [<Test>]
    let RoundTrip_ById () =
        let user = User.create_with_discord ("RoundTripById", 11111uL)
    ...
    let RoundTrip_ByUsername_ExactCase () =
        let user = User.create_with_discord ("UsernameExactCase", 22222uL)
        let id = User.save_new user
    ...
    let RoundTrip_ByUsername_Lowercase () =
        let user = User.create_with_discord ("UsernameLowercase", 33333uL)
        let id = User.save_new user
    ...
    let RoundTrip_ByUsername_Underscore () =
        User.create_with_discord ("UnderXScore", 0uL) |> User.save_new |> ignore
        let user = User.create_with_discord ("Under_Score", 33333uL)
        let id = User.save_new user
    ...
    let RoundTrip_ByUsername_MixedCase () =
        let user = User.create_with_discord ("UsErNaMeMiXeDcAsE", 44444uL)
        let id = User.save_new user
    ...
    let RoundTrip_ByAuthToken () =
        let user = User.create_with_discord ("AuthToken", 55555uL)
        let id = User.save_new user
    ...
    let RoundTrip_ByDiscordId () =
        let user = User.create_with_discord ("DiscordId", System.UInt64.MaxValue - 2uL)
        let id = User.save_new user
    ...
    [<Test>]
    let UpdateBadges () =
        let user = User.create_with_discord ("UpdateBadges", 66666uL)
        let id = User.save_new user
    ...
    [<Test>]
    let UpdateColor () =
        let user = User.create_with_discord ("UpdateColor", 77777uL)
        let id = User.save_new user
    ...
    [<Test>]
    let UpdateLastSeen () =
        let user = User.create_with_discord ("UpdateLastSeen", 88888uL)
        let id = User.save_new user
    ...
    [<Test>]
    let SetAuthToken () =
        let user = User.create_with_discord ("SetAuthToken", 99999uL)
        let id = User.save_new user
    ...
    [<Test>]
    let Search () =
        User.create_with_discord ("AAASearch1", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("SearchBBB2", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("CCCSearch", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("search", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("SEARCH_", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("DDDRedHerring1", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("RedHerring2", 0uL) |> User.save_new |> ignore
    ...
    let Search_Underscore () =
        User.create_with_discord ("Under__score", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("Underaascore", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("Underbbscore", 0uL) |> User.save_new |> ignore
    ...
    [<Test>]
    let List () =
        User.create_with_discord ("ListUser1", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("ListUser2", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("ListUser3", 0uL) |> User.save_new |> ignore
    ...
    let List_BigPageNumber () =
        User.create_with_discord ("ListBigPageUser1", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("ListBigPageUser2", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("ListBigPageUser3", 0uL) |> User.save_new |> ignore
    ...
    [<Test>]
    let ByIds () =
        let id1 = User.create_with_discord ("ByIds1", 0uL) |> User.save_new
        let id2 = User.create_with_discord ("ByIds2", 0uL) |> User.save_new
        let id3 = User.create_with_discord ("ByIds3", 0uL) |> User.save_new
    ...
    let ByIds_Duplicates () =
        let id1 = User.create_with_discord ("ByIdsDuplicates1", 0uL) |> User.save_new
        let id2 = User.create_with_discord ("ByIdsDuplicates2", 0uL) |> User.save_new
        User.create_with_discord ("ByIdsDuplicates3", 0uL) |> User.save_new |> ignore
    ...
    let Count() =
        ...
        User.create_with_discord ("Count1", 0uL) |> User.save_new |> ignore

        let count_after_1 = User.count()

        User.create_with_discord ("Count2", 0uL) |> User.save_new |> ignore
        User.create_with_discord ("Count3", 0uL) |> User.save_new |> ignore
    ...
    [<Test>]
    let Rename() =
        let user_1 = User.create_with_discord("RenameMe1", 0uL) |> User.save_new
        let user_2 = User.create_with_discord("RenameMe2", 0uL) |> User.save_new
